...
sprintf('Range of TV: Lower Bound %.2f, Upper Bound %.2f', tv.range[1], tv.range[2])
...
sprintf('Range of Sales: Lower Bound %.2f, Upper Bound %.2f', sales.range[1], sales.range[2])
